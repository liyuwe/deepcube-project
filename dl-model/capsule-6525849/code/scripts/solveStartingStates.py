...
for method in methods:
    data["solutions"][method] = [None]*states.shape[0]
    data["times"][method] = [None]*states.shape[0]
    data["nodesGenerated_num"][method] = [None]*states.shape[0]
...
print("%i total states" % (states.shape[0]))
